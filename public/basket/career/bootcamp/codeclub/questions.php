					...
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="row">
								...
								<textarea  name="question_title" id="question_title" autocomplete="off" class="form-control" ></textarea>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<!--<input type="text" name="option_title_1" id="option_title_1" autocomplete="off" class="form-control" />-->
									<textarea  name="option_1" id="option_1" autocomplete="off" class="form-control" ></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-8">
									...
									<textarea  name="option_2" id="option_2" autocomplete="off" class="form-control" ></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-8">
									...
									<textarea  name="option_3" id="option_3" autocomplete="off" class="form-control" ></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-8">
									...
									<textarea  name="option_4" id="option_4" autocomplete="off" class="form-control" ></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
