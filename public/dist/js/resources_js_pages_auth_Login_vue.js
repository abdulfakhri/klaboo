          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                */
                _this.form.post('/api/login').then(function (_ref) {
                  var data = _ref.data;
                  ...
                  _this.$router.back();
                })["catch"](function (e) {// console.log(e.response.data.message)
                });
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "right-tag__input login--left-border",
    "class": {
    ...
    staticClass: "checkbox-checkmark checkbox-checkmark-remember"
  ...
  }, [_c("b", [_vm._v("Sign Up")])])], 1), _vm._v(" "), _c("p", [_c("router-link", {
    staticClass: "login-link",
    attrs: {
      to: {
